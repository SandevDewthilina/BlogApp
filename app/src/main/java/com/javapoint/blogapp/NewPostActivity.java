...
public class NewPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postProgress = findViewById(R.id.new_post_progress);
                ...
                filepath.putFile(postImageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    filepath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            storageReference.child("post_images/thumbs").child(random_name + ".jpg").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        @Override
                                public void onSuccess(Uri uri) {
                                    ...
                                    firebaseFirestore.collection("Posts").add(postMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                        ...
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(NewPostActivity.this, "Your post is uploaded ", Toast.LENGTH_LONG).show();
                                            ...
                                            Toast.makeText(NewPostActivity.this, "UPLOADING POST ERROR: " + error, Toast.LENGTH_LONG).show();
                       ...
                       /* if (task.isSuccessful()) {
                            ...
                            String error = task.getException().getMessage();
                            Toast.makeText(NewPostActivity.this, "POST UPLOAD ERROR: " + error, Toast.LENGTH_LONG).show();
